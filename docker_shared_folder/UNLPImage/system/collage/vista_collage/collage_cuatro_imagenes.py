...
class CuatroImagenesCollage:
    ...
    def insertar_img_segun_formato(self):
        ...
        if self.formato == "-FORMATOTRES-":
            self.generar_collage_formato_tres()
...
if __name__ == "__main__":
    pantalla = CuatroImagenesCollage()
    pantalla.iniciar()
