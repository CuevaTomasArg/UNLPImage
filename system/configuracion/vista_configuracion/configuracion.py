...
from system.configuracion import acceso_a_datos_configuracion as adc
from system.configuracion import settings_config as sconf
...
def ejecutar():
    """
    Esta función ejecuta la ventana "configuración" de la aplicacion
    """
